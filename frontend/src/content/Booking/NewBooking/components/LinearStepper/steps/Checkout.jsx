...
function Checkout() {
  ...
  function downloadDiv(divName) {
    let downloadContent = document.getElementById(divName);
    html2canvas(downloadContent, { allowTaint: true }).then(function (canvas) {
      let link = document.createElement('a');
      document.body.appendChild(link);
      link.download = 'ticket_info.jpg';
    ...
    <div id="checkoutTicket">
      ...
      <div className="cs-invoice_btns cs-hide_print">
        ...
        <Button
          ...
          onClick={() => downloadDiv('checkoutTicket')}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="ionicon"
